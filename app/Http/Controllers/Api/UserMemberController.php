...
class UserMemberController extends Controller
{
    ...
    {   
        ...
        if(isset($r->nama)) $data->where('name','LIKE',"%{$r->nama}%");
        if(isset($r->no_anggota)) $data->where('no_anggota_platinum',"LIKE","%{$r->no_anggota}%");
        ...
        foreach($data as $k => $item){
            ...
            $items[$k]['saldo_awal'] = $item->plafond;
            $items[$k]['saldo'] = $item->plafond_digunakan;
