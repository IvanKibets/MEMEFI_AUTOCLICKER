...
Route::group(['middleware' => 'cors', 'json.response'], function(){
	...
	Route::post('auth-pin', [\App\Http\Controllers\Api\UserController::class,'requestPin']);
	...
	Route::post('transaction/void-item',[\App\Http\Controllers\Api\TransactionController::class,'voidItem']);
	...
	Route::post('submit-aktual-tunai',[\App\Http\Controllers\Api\TransactionController::class,'submitAktualTunai'])->name('api.submit-aktual-tunai');
	Route::post('submit-tunai-awal',[\App\Http\Controllers\Api\TransactionController::class,'submitTunaiAwal'])->name('api.submit-tunai-awal');
	Route::post('check-voucher',[\App\Http\Controllers\Api\TransactionController::class,'checkVoucher'])->name('api.check-voucher');
	Route::post('submit-login-kasir', [\App\Http\Controllers\Api\UserController::class,'loginToko']);
});
...
Route::group(['middleware' => 'auth:api'], function(){
	...
	Route::post('transaction/data-anggota',[\App\Http\Controllers\Api\TransactionController::class,'dataAnggota']);
	Route::post('get-daily-cash',[\App\Http\Controllers\Api\TransactionController::class,'dailyCash'])->name('api.get-daily-cash');
