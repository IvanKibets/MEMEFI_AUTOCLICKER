...
<body>
    ...
    <table style="width:100%">
        ...
        @foreach($data->items as $item)
            <tr>
                <td style="width:55%;font-size: 9px;">{{$item->description}}</td>
                <td style="width:10%;">{{$item->qty}}</td>
                <td style="width:10%;font">{{format_idr($item->price)}}</td>
    ...
    <br />
    <hr style="border-top:0;border-bottom: 1px dotted;" />
</body>
</html>