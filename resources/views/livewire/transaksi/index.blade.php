    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="header row">
                ...
                <div class="from-group col-md-2" wire:ignore>
                ...
                <div class="col-5">
                    ...
                    <a href="javascript:void(0)" class="btn btn-warning" data-toggle="modal" data-target="#modal_daily_cash"><i class="fa fa-desktop"></i> Daily Cash</a>
                    <span wire:loading>
                           ...
                           <tr>
                                ...
                                <th class="text-center pt-2">
                                    @if($cetak_invoice==true)
                                        <p><a href="javascript:void(0)" class="btn btn-info" wire:click="$emit('calc_invoice')" data-toggle="modal" data-target="#modal_submit_invoice"><i class="fa fa-check-circle"></i> Submit Invoice ({{count(array_filter($check_id))}})</a></p>    
                        ...
                        <tbody>
                            ...
                            @foreach($data as $k => $item)
                                <tr>
                                    ...
                                    <td><a href="{{route('transaksi.items',$item->id)}}?{{http_build_query($filter)}}">{{$item->no_transaksi}}</a></td>
...
<div class="modal fade" id="modal_daily_cash" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <livewire:transaksi.daily-cash />
        </div>
    </div>
</div>
...
@push('after-scripts')
    ...
    <script>
        ...
        Livewire.on('change-filter',(param)=>{
