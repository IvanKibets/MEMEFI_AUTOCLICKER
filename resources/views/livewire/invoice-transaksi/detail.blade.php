                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($data->items as $k => $item)
                            <tr>
                                ...
                                <td>
                                    @if(isset($item->transaksi->anggota->no_anggota_platinum))
                                        <a href="{{route('user-member.edit',$item->transaksi->user_member_id)}}" target="_blank">{{isset($item->transaksi->anggota->name) ? $item->transaksi->anggota->name : '-'}}</a>
                                    @endif
                                </td>
