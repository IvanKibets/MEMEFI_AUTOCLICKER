...
<div class="clearfix row">
                    ...
                    <table class="table table-hover m-b-0 c_list">
                        <thead style="background: #eee;">
                            <tr>
                                ...
                                <th colspan="3" class="text-center">Plafond Bayar Nanti</th>
                                <th rowspan="2"></th>
                            </tr>
                            <tr>
                                <th>Pokok</th>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="javascript:void(0)" wire:click="set_member({{$item->id}})" data-toggle="modal" data-target="#modal_set_pin"><i class="fa fa-key"></i> Set PIN</a>
                                            @if($item->status!=4)
    ...
    <div wire:ignore.self class="modal fade" id="modal_set_pin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form wire:submit.prevent="changePin">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-sign-in"></i> Set PIN</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true close-btn">×</span>
                        </button>
                    </div>
