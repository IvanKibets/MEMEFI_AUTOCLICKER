                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                @if($item->status==0)
                                                    <a href="javascript:void(0)" class="dropdown-item" wire:click="$set('selected_id',{{$item->id}})" data-toggle="modal" data-target="#modal_delete"><i class="fa fa-trash text-danger"></i> Delete</a>
                                                @endif
